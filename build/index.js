...
const PostSelection = _ref => {
  ...
  const loadOptions = (inputValue, callback) => {
    ...
    isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()(endpoint).then(response => response.json()).then(posts => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select_async__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: "select-two",
    value: selectedPosts,
    onChange: newSelectedPost => setSelectedPosts(newSelectedPost),
    isMulti: true,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PostSelection);

/***/ }),

/***/ "./src/components/SelectedPosts.js":
/*!*****************************************!*\
  !*** ./src/components/SelectedPosts.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SelectedPosts = _ref => {
  ...
  return posts.map(post => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: post.id
    ...
    className: "components-card-media"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: post.media_url,
    alt: post.media_alt
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "lower-card"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CardBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalHeading, {
    level: 4
  }, post.title.rendered), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalText, null, post.date_formatted)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CardBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalText, {
    upperCase: true,
    variant: "muted"
  }, post.categories.join(', '))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.CardFooter, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: post.link,
    target: "_blank",
    rel: "noopener noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Read More', 'takiainen-post-grid'), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SelectedPosts);
...
/* harmony import */ var _components_SelectedPosts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/SelectedPosts */ "./src/components/SelectedPosts.js");
/* harmony import */ var _components_PostSelection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/PostSelection */ "./src/components/PostSelection.js");
...
async function getPost(post_id) {
  const response = await isomorphic_fetch__WEBPACK_IMPORTED_MODULE_7___default()(`/wp-json/wp/v2/posts/${post_id}`);
...
async function getCardMedia(post) {
  if (post.featured_media) {
    const response = await isomorphic_fetch__WEBPACK_IMPORTED_MODULE_7___default()(`/wp-json/wp/v2/media/${post.featured_media}`);
    return await response.json();
  } else {
    return null;
  }
...
async function getCategories(post) {
  ...
  return await Promise.all(category_ids.map(async id => {
    const response = await isomorphic_fetch__WEBPACK_IMPORTED_MODULE_7___default()(`/wp-json/wp/v2/categories/${id}`);
...
const Edit = _ref => {
  ...
  const [selectedPosts, setSelectedPosts] = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)(fetchedPosts.map(post => ({
    value: post.id,
    label: post.title.rendered
  })));
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(() => {
    const fetchPosts = async () => {
      ...
      const fetchPostPromises = selectedPosts.map(async selected_post => {
        const post = await getPost(selected_post.value);
        post.categories = await getCategories(post);
        const media = await getCardMedia(post);
        post.media_url = media ? media.source_url : 'https://placekitten.com/g/300/300';
        post.media_alt = media && media.alt_text ? media.alt_text : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Featured image for the post');
        let date_object = new Date(post.date);
        post.date_formatted = date_object.getDate() + '.' + (date_object.getMonth() + 1) + '.' + date_object.getFullYear();
        return post;
      });
      ...
      if (JSON.stringify(selectedPosts) !== JSON.stringify(newSelectedPosts)) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_6__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Shown Posts', 'takiainen-post-grid')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_PostSelection__WEBPACK_IMPORTED_MODULE_5__["default"], {
    selectedPosts: selectedPosts,
    setSelectedPosts: setSelectedPosts
  }))), fetchedPosts && fetchedPosts.length >= 3 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.__experimentalGrid, {
    alignment: "spaced",
    gap: "4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_SelectedPosts__WEBPACK_IMPORTED_MODULE_4__["default"], {
    posts: fetchedPosts
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Choose three posts.', 'takiainen-post-grid')
  }));
};
...
const Save = _ref => {
  ...
  fetchedPosts && fetchedPosts.length >= 3 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "components-grid"
  },
  // Map through each post and render the post data
  fetchedPosts.map(post => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "components-card-body"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", {
    className: "components-text components-heading"
  }, post.title.rendered), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "components-text"
  }, post.date_formatted)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "components-card-body"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "components-text"
  }, post.categories.join(', '))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "components-card-footer"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: post.link,
    target: "_blank",
    rel: "noopener noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Read More', 'takiainen-post-grid'), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "arrow-right"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    height: "1em",
...
/* harmony export */   useAsync: () => (/* reexport safe */ _dist_useAsync_9eb532f6_esm_js__WEBPACK_IMPORTED_MODULE_2__.u)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/extends */ "./node_modules/@babel/runtime/helpers/esm/extends.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _dist_Select_ce3716e1_esm_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../dist/Select-ce3716e1.esm.js */ "./node_modules/react-select/dist/Select-ce3716e1.esm.js");
...
/* harmony import */ var _dist_useAsync_9eb532f6_esm_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../dist/useAsync-9eb532f6.esm.js */ "./node_modules/react-select/dist/useAsync-9eb532f6.esm.js");
...
var AsyncSelect = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (props, ref) {
  var stateManagedProps = (0,_dist_useAsync_9eb532f6_esm_js__WEBPACK_IMPORTED_MODULE_2__.u)(props);
  var selectProps = (0,_dist_useStateManager_7e1e8489_esm_js__WEBPACK_IMPORTED_MODULE_16__.u)(stateManagedProps);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_dist_Select_ce3716e1_esm_js__WEBPACK_IMPORTED_MODULE_17__.S, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ref: ref
  }, selectProps));
});
...
function useAsync(_ref) {
  ...
  var onInputChange = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(function (newValue, actionMeta) {
    var inputValue = (0,_index_6ea50319_esm_js__WEBPACK_IMPORTED_MODULE_5__.L)(newValue, actionMeta, propsOnInputChange);
    if (!inputValue) {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/takiainen-post-grid","version":"0.1.0","title":"Takiainen Post Grid","category":"widgets","icon":"admin-page","description":"A simple Post Grid Block.","supports":{"html":false},"attributes":{"fetchedPosts":{"type":"array","items":{"type":"object"},"default":[]}},"textdomain":"takiainen-post-grid","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktakiainen_post_grid"] = globalThis["webpackChunktakiainen_post_grid"] || [];
